export default {
  common: {
    ...
    success: '成功しました',
    failed: '失敗しました',
    about_head: 'このプロジェクトは中国聯通デジタル科学技術可視化チームがMITオープンソース協定に基づいて入念に作成した。',
    about_body: 'デルは、データの理解と分析を容易にするための高品質な可視化ソリューションの提供に取り組んでいます。本プロジェクトがあなたに役立つと思ったら、私たちはあなたを友人に推薦するように心から招待します。また、連結可視化生態群への参加を歓迎し、デジタル双子、可視化、人工知能などの最先端技術を一緒に検討してください。あなたと一緒にグループで交流し、素晴らしい未来を創造することを楽しみにしています！ ',
  },
  chat: {
    newChat: '新しい会話',
