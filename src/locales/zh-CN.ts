export default {
  common: {
    ...
    about_head: '本项目由联通数科可视化团队精心制作，遵循 MIT 开源协议。',
    about_body: '我们致力于提供高质量的可视化解决方案，帮助您更好地理解和分析数据。如果您觉得本项目对您有帮助，我们诚挚地邀请您将其推荐给您的朋友。同时，欢迎您加入联通可视化生态群，与我们一起探讨数字孪生、可视化和人工智能等前沿技术。期待与您在群里共同交流，共创美好未来！',
  },
  chat: {
    newChatButton: '新建聊天',
    newChat: '新的对话',
