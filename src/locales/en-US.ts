export default {
  common: {
    ...
    about_head: 'This project is meticulously produced by the visualization team of China Unicom Digital Tech, following the MIT open source protocol.',
    about_body: 'If you think this can be helpful to you, welcome to recommend it to your friends, and also welcome everyone to join the Unicom Visualization Ecological Group, where you can discuss digital twins, visualization, and AI together.    ',
  },
  chat: {
  ...
  setting: {
    ...
    chatgpt_memory_title: 'ANOV-GPT\'s memory capacity',
    chatgpt_memory_memo: 'The stronger the memory, the more context ANOV-GPT can remember during conversations, but it may consume more costs.',
    ...
    chatgpt_top_p_title: 'The personality of ANOV-GPT',
    chatgpt_top_p_1_memo: 'Tends to precise analysis, reducing the possibility of ANOV-GPT\'s nonsense.',
